...
For CSS, I went with the **milligram** stylesheet which I extended with my own colors and typography stuff. **CSS modules** came pre-installed, so I used those for all
